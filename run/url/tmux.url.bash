...
# rename 
chmod +x "$download_directory/tmux";
echo "Permissões atribuitas!";

# link simbolico
mkdir -p "$bin_directory";
ln -sf "$download_directory/tmux" "$bin_directory/tmux";
chmod +x "$bin_directory/tmux";
echo "Link Simbolico gerado! '$bin_directory/tmux'";
