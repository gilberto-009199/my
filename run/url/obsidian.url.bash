...
# rename 
chmod +x "$setup_run_directory/obsidian"
echo "Permissões atribuitas!"

# link simbolico
mkdir -p "$bin_run_directory";
ln -sf "$setup_run_directory/obsidian" "$bin_run_directory/obsidian";
chmod +x "$bin_run_directory/obsidian";
echo "Link Simbolico gerado! '$bin_run_directory/obsidian'";
