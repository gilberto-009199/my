...
# rename 
file_exec="$download_directory/duckstation";
...
ln -sf "$file_exec" "$bin_directory/duckstation";

chmod +x "$bin_directory/duckstation";
echo "Link Simbolico gerado! '$bin_directory/duckstation'";
