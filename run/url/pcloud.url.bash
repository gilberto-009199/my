...
# rename 
file_exec="$setup_run_directory/pcloud";
...
ln -sf "$file_exec" "$bin_run_directory/pcloud";

chmod +x "$bin_run_directory/pcloud";
echo "Link Simbolico gerado! '$bin_run_directory/pcloud'";
